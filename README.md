...
[^usage]:
	...
	messages is hard, and avoiding that challenge by printing
	a usage statement instead of an error message is lazy.
	Supplementing an error message with a usage statement is
	just annoying.
[^naming]:
...
[^ts]:
	Never display times like "07:48".  Always write "07:48:00-06:00"
	or "13:48:00Z" or "0648T-7".  Do not use names; use numbers.
	Quick, how much time is there between "06:48 PST" and "19:18
	IST"?  Approximately where in the world is EAT?  Now, answer
	those questions for "06:48T-0700" and "19:18T+0530" and
	"UTC+3".  Using timezone names requires external information,
	and it is better to convey that information directly.
